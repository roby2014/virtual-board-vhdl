...
full_path = str(dir) + "/UsbPort_VPI_GHDL.vhd"
f = open(full_path, "w")
f.write(
...
#
# Open top entity file and replace the UsbPort component declaration with UsbPort_VPI_GHDL
...
new_component_name = match.group(0).replace(match.group(1), "UsbPort_VPI_GHDL")
...
new_usb_port_name = match.group(0).replace(match.group(1), "UsbPort_VPI_GHDL")
